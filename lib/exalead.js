...
const SEARCH_ENGINE_URL = "http://www.exalead.com/search";
const COUNT_SELECTOR = "small.pull-right";
const LINK_SELECTOR = ".media a";
const NEXT_SELECTOR = ".pagination ul li:last-child a";
const ENGINE = Path.basename(__filename, ".js");
const PERSIST_NAME = "sec-" + ENGINE;
const SEARCH_TEXTBOX_SELECTOR = '.input-append input[name="q"]';
const SEARCH_SUBMIT_SELECTOR = '.input-append button[type="submit"]';
